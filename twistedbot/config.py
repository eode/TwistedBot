...
PATHFIND_MAX = 256    # (future) Max distance to use pathfinder for
PATHFIND_MIN = 15     # (future) Always use at least this much pathfinding
PATHFIND_EXEC_TIME_LIMIT = 1.0 / 10   # in seconds.
